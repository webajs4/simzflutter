  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: HomeUiHelper().customText('Keyboard Lessons', 20, FontWeight.w600, Color.fromRGBO(56, 15, 67, 1))
        ),
        body: Center(
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            trailing: TextButton(
                              ...
                              onPressed: (){}, child: HomeUiHelper().customText('Download', 16, FontWeight.w600, Color.fromRGBO(69, 10, 14, 1))),
                            leading: Image.asset(
                                'lib/assets/images/sheets.png'),
                            title: HomeUiHelper().customText('${s['sheet_name']}', 20, FontWeight.w700, Color.fromRGBO(69, 10, 14, 1)),
                          ),
                        ),
                      );
                    });
