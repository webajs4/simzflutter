...
class PractiseConsumers extends ConsumerWidget {
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: practiseAsyncValue.when(data: (practise){
          if(practise.isEmpty){
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    trailing: IconButton(
                      icon: Icon(Iconsax.audio_square,
                        color: Color.fromRGBO(27, 71, 113, 1),
                      ),
                      onPressed: (){},
                    ),
                    leading: Image.asset('lib/assets/images/sheets.png'),
                    title: HomeUiHelper().customText('${p['practise_name']}', 20, FontWeight.w700, Color.fromRGBO(27, 60, 95, 1)),
                  ),
                ),
              );
            },
